...
CONFIGFOLDER='/root/.desirecore'
COIN_DAEMON='desired'
COIN_CLI='desire-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/lazyboozer/Desire/releases/download/Desire-v.0.12.2.2/desire-0.12.2.2-linux64.tar.gz'
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Desire address donations : xxx${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}desire-cli getinfo. ${CYAN} Compare the Blocks line with the explorer to ensure the VPS is synced${NC}"
 echo -e "${GREEN}desire-cli masternode status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
